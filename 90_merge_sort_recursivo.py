...
# Divida a lista na metade até que cada sublista contenha apenas 1 elemento.
# Portanto, já ordenada. Repetidamente, intercale as sublistas  para produzir
# novas listas ordenadas
